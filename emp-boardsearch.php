...
<div class="container">
  ...
  //  $servername = "localhost";
   ...
   // }
    ...
    $sql="select id,name,amount,instocknum,price from mystore.product where 1";
        ...
        <div class="item col-lg-4">
            <div class="thumbnail">
                <div class="caption">
                    ...
                    <!--<p class="list-group-item-text"><?php echo $row["detail"]; ?></p>-->
                    <div class="row">
                        <div class="col-md-6">
						...
						<!---having trouble getting id for some reason-->
							...
							<form action="emp-boarditemremove.php" method="POST">
                            <button class="btn btn-success" name="itemremove" value="<?php $_SESSION['itemdelete'] = $row["id"]; ?>">Remove Item <br/>from Inventory</button>
							</form>
						</div>
                    </div>
                </div>
