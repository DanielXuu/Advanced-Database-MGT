...
<div class="container">
      ...
      <div class="jumbotron">
       ...
       $empdelete = $_POST['itemremove'] ;



        $sqlempremove="DELETE from mystore.salesperson WHERE name = '$empdelete'";

		if ($conn->query($sqlempremove)===TRUE){
            echo $empdelete.' has been removed from employee list.';}
        else{
            echo ' error in removing '.$empdelete.'.';
        }
