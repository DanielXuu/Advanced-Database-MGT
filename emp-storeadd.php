    ...
    <div class="jumbotron">
        ...
        <div id="top">
            <div id="dashleft">
                ...
                $sql1="select * from mystore.store where sID=$sID";
                $result1 =$conn->query($sql1);

                if($result1->num_rows>0)
                {
                    $sqlempremove="DELETE from mystore.store where sID=$sID";
                    $conn->query($sqlempremove);
                    $sql2="insert into mystore.store values ('$sID','$address','$salesperson','$region');";
                    $conn->query($sql2);
