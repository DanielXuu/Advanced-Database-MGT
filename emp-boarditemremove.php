		...
		<div id="prodsearch">
		 ...
		 <label for="search" >Search</label>
			...
			<button class="btn btn-primary"type="submit">Go!</button>
		 		 ...
		 		 <?php
       $remove=$_POST["itemremove"];
	   $idelete = $_SESSION['itemdelete'] ;
	 

    $sqlitemremove="DELETE from mystore.product WHERE ID = $idelete";
   
    if ($conn->query($sqlitemremove)===TRUE){
	echo 'Item '.$idelete.' has been removed from inventory.';}
	else{
		echo ' error in deleting item '.$idelete.'.';
	}
