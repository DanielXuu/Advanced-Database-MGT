...
if ($statel!=2) {
  ...
  echo "Zip Code must be 5 numbers  <a href='createacct.php'>Back</a> <br/>";
}
else if($result->num_rows>0)
{
    echo 'Failed:Account already exists <a href="createacct.php">Back</a> <br/>';
}
else
{
    $sql1="insert into mystore.customer_home values ('$username','$fullname','$email','$street','$zip','$gender','$marriage','$age','$income');";
