...
<html lang="en">
  ...
  <body>
   ...
   $conn = new mysqli($servername, $username, $password);
    ...
    if (trim($name)!= "" )
    {
        $sqlname = "update mystore.customer_home set name = '$name' where username = '$_SESSION[username]'";
	...
	if ($pass!= "" )
    {
	 ...
	 if (trim($email)!= "" )
    {
        $sqlemail = "update mystore.customer_home set email = '$email' where username = '$_SESSION[username]'";
	 ...
	 if (trim($addline)!= "" )
    {
        $sqladdline = "update mystore.customer_home set addline = '$addline' where username = '$_SESSION[username]'";
	...
	if (trim($zip)!= "" )
    {
        $sqlzip = "update mystore.customer_home set zip = '$zip' where username = '$_SESSION[username]'";
	 ...
	 if (trim($state)!= "" )
    {
	 ...
	 if (trim($age)!= "" )
    {
        $sqlage = "update mystore.customer_home set age = '$age' where username = '$_SESSION[username]'";
		if($conn->query($sqlage)===TRUE){
			echo ' Age Updated <br/>';
		}
		else{ echo'Age not updated'. $conn->error;}
	}
	 if (trim($income)!= "" )
    {
        $sqlincome = "update mystore.customer_home set income = '$income' where username = '$_SESSION[username]'";
	 ...
	 if ($gender != "Select" )
    {
        $sqlgender = "update mystore.customer_home set gender = '$gender' where username = '$_SESSION[username]'";
		if($conn->query($sqlgender)===TRUE){
			echo 'Gender Updated <br/>';
		}
		else{ echo'gender not updated'. $conn->error;}
    }
